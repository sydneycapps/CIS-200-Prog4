...
public abstract class Parcel : IComparable<Parcel>
{
    ...
    public int CompareTo(Parcel p2)
    {
        ...
        if (this == null) // Only this is null?
            return -1;    // null is less than any actual cost

        if (p2 == null) // Only p2 is null?
            return 1;   // Any actual cost is greater than null

        return this.CalcCost().CompareTo(p2.CalcCost()); // default sort ascending by cost
    }
}
